...
import { getPlan, getCartItems, deleteCartItem, deleteWishlistItem, addToWishlist} from '../store/actions'
...
const Checkout = () => {
  ...
  store = useSelector(state => state.subscriptions),
  ...
  useEffect(() => {
    ...
    // const test = dispatch(getPlan(parseInt(id)))
    // dispatch(getPlan(parseInt(0)))
    // return () => dispatch(getPlan(parseInt(0)))
